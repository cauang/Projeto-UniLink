            ...
            <div className="lg:col-span-2 bg-white rounded-lg p-4 md:p-6 shadow-sm max-h-[70vh] overflow-auto">
              <div className="mb-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button onClick={prevMonth} aria-label="Mês anterior" className="border rounded px-2 py-1">◀</button>
                  <button onClick={nextMonth} aria-label="Próximo mês" className="border rounded px-2 py-1">▶</button>
                </div>
              </div>
